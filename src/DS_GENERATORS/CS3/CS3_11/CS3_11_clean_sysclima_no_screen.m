...
%%
log_inx = (ids.DateTime > datetime('06-Jan-2017')).*(ids.DateTime < datetime('22-Jan-2017'));
...
save(fullfile(folder_path,'data','MATLAB_FORMAT','CS3_9_sysclima_no_heater_no_screen.mat'),'ids')
